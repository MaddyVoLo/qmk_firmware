...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_RSHIFT_COLEMAK] = ACTION_TAP_DANCE_DOUBLE(KC_RSFT, COLEMAK),
    [TD_RSHIFT_QWERTY] = ACTION_TAP_DANCE_DOUBLE(KC_RSFT, QWERTY)
};
 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,   KC_LBRC, KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, TD(TD_RSHIFT_COLEMAK),
 ...
 */
 ...
 [_COLEMAK] = LAYOUT(
  TD(TD_ESC_CAPS),   KC_1,   KC_2,    KC_3,    KC_4,    KC_5,            KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_GRV,
  KC_TAB,   KC_Q,   KC_W,    KC_F,    KC_P,    KC_G,                     KC_J,    KC_L,    KC_U,    KC_Y,    KC_PIPE, KC_MINS,
  KC_LCTL,  KC_A,   KC_R,    KC_S,    KC_T,    KC_D,                     KC_H,    KC_N,    KC_E,    KC_O,    KC_SCLN, KC_QUOT,
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,   KC_RBRC, KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, TD(TD_RSHIFT_QWERTY),
           KC_LALT, KC_LGUI,LOWER, KC_SPC,                                 KC_ENT,   RAISE,   KC_BSPC, KC_RGUI
),
