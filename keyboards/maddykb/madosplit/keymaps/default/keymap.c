...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_RSHIFT_COLEMAK] = ACTION_TAP_DANCE_LAYER_TOGGLE(KC_RSFT, _COLEMAK),
    [TD_RSHIFT_QWERTY] = ACTION_TAP_DANCE_LAYER_TOGGLE(KC_RSFT, _QWERTY),
};
 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,   KC_LBRC,  KC_BSPC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, TD(TD_RSHIFT_COLEMAK),
