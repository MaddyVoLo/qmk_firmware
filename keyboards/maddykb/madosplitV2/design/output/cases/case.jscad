function standoff_extrude_3_outline_fn(){
    return CAG.circle({"center":[175,-80],"radius":2.5})
.union(
    CAG.circle({"center":[228.5,-52.4],"radius":2.5})
).union(
...
function mounting_extrude_3_outline_fn(){
    return CAG.circle({"center":[175,-80],"radius":1.5})
.union(
    CAG.circle({"center":[228.5,-52.4],"radius":1.5})
).union(
